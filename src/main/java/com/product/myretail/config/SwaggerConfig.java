/*
 * package com.product.myretail.config;
 * 
 ...
 * basePackage("com.product.myretail")) .build(); }
 * 
 * 
 * private Predicate<String> postPaths() { return (Predicate<String>)
 * regex("/"); }
 * 
 * 
 * 
 * private ApiInfo apiInfo() { return new
 * ApiInfoBuilder().title("JavaInUse API") .build(); }
 * 
 * 
 * }
 */